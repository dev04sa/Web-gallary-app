...
//         </form>
//       </div>
//       <div className="filters mb-4 flex flex-row justify-evenly items-center">
//         {buttons.map((bt) => {
//           return (
//             <div
//               key={bt.id}
//               className={`cursor-pointer mr-4 mb-2 p-2 rounded-lg border border-gray-300 hover:bg-gray-100 ${bt.color}`}
      ...
      <div className="filters mb-4 flex flex-row justify-evenly items-center">
        {buttons.map((bt) => {
          return (
            <div
              key={bt.id}
              className={`cursor-pointer mr-4 mb-2 p-2 rounded border border-gray-300 ${bt.color} ${bt.hoverColor}`}
              onClick={() => handleSelection(bt.name)}
            >
              {bt.name}
            </div>
